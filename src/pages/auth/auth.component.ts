...
@Component({
  ...
  template: `
    <div class="bg-background-light dark:bg-background-dark font-sans transition-colors duration-300 min-h-screen flex flex-col items-center justify-center p-4 animate-page-enter">
      ...
      <main class="w-full max-w-[440px]">
        <div class="bg-white dark:bg-card-dark border border-gray-200 dark:border-white/10 rounded-2xl overflow-hidden shadow-2xl">
            ...
            <form class="space-y-6" [formGroup]="loginForm" (ngSubmit)="onSubmit()">
              <div class="space-y-2">
                ...
                <div class="relative group">
                  ...
                  <input class="w-full pl-12 pr-4 py-3 bg-gray-50 dark:bg-[#1C1C1C] border border-gray-200 dark:border-[#333] rounded-lg text-gray-900 dark:text-white placeholder:text-gray-500 transition-all" 
                    id="email" 
              ...
              <button class="w-full bg-primary hover:bg-[#C5A02E] text-black py-4 rounded-lg font-bold flex items-center justify-center space-x-2 transition-all transform hover:scale-[1.01] active:scale-[0.99] btn-glow disabled:opacity-70 disabled:cursor-wait btn-primary-shimmer" type="submit" [disabled]="isLoading()">
                @if (isLoading()) {
              ...
              <button (click)="continueWithTelegram()" class="w-full bg-[#1C1C1C] border border-[#333] hover:border-primary/50 text-gray-200 dark:text-white py-4 rounded-lg font-semibold flex items-center justify-center space-x-3 transition-all transform hover:scale-[1.01] active:scale-[0.99]" type="button">
          ...
          <div class="px-8 py-4 bg-gray-50/50 dark:bg-black/20 border-t border-gray-200 dark:border-white/10 text-center">
            <p class="text-[11px] text-gray-500 tracking-wide uppercase font-accent">
